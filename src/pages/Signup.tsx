    ...
    <div className="flex flex-col min-h-screen bg-white">
      <div className="flex-1 flex flex-col justify-center px-8 py-12">
        ...
        >
          ...
          <h2 className="text-4xl font-black text-slate-900 mb-2 tracking-tight editorial-header">Join the Hub.</h2>
          <p className="text-slate-500 mb-10 italic editorial-header">Start your 100 Level journey today.</p>
          ...
          <form onSubmit={handleSignup} className="space-y-6">
            ...
            >
              {loading ? 'Creating Account...' : 'Initialize Hub Access'}
          ...
          <p className="mt-10 text-center text-slate-500 text-sm font-medium">
            Already a member?{' '}
            <Link to="/login" className="text-teal-custom font-black hover:underline underline-offset-8 decoration-2">
              Sign In
            </Link>
          </p>
        </motion.div>
